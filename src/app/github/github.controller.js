    ...
    function GithubController($uibModal, GithubUserRepository, GithubUserSearch, $localStorage, $scope, $state, $log, $timeout, $interval, toastr, Github, GithubUser, $http, leafletData) {
        ...
        vm.gridData = {
            columnDefs: [
                ...
                {
                    field: 'html_url',
                    displayName: 'Url do Repositorio',
                ...
                },
                {
                    ...
                    cellTemplate: '<button id="editBtn" type="button" class="btn-small" ng-click="grid.appScope.mostradesc(row.entity)" >Exibir</button> '
                }
            ],
            data: []
        };
                    ...
                    vm.gridData = {
                        columnDefs: [
                            ...
                            },
                            {
                                ...
                                cellTemplate: '<button id="editBtn" type="button" class="btn-small" ng-click="grid.appScope.mostrausrrepos(row.entity)" >Exibir</button> '
                            }
                        ],
                        data: []
                    }
        ...
        vm.userreposData = {
            columnDefs: [
                ...
                {
                    field: 'html_url',
                    displayName: 'Url do Repositório',
                    cellTemplate: '<a target="_blank" href="{{row.entity.html_url}}">{{row.entity.html_url}}</a> '
                },
                {
                    field: 'description',
                ...
                },
                {
                    ...
                    cellTemplate: '<button id="editBtn" type="button" class="btn-small" ng-click="grid.appScope.mostradetalhes(row.entity)" >Exibir</button> '
                }
            ],
            data: []
        };
        ...
        $scope.queryUserRepos = function(_usrname) {
            GithubUser.query({
                ...
                var modalInstance = $uibModal.open({
                    ...
                    ariaLabelledBy: 'modal-title',
                    ariaDescribedBy: 'modal-body',
                    template: '<h1>Exibindo Repositórios de ' + _usrname + '</h1><div ui-grid="vm.userreposData" class="myGrid" ui-grid-cellNav></div>',
                    scope: $scope,
                    size: undefined,
                    appendTo: undefined,
                    resolve: {
